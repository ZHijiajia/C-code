...
int main()
{
	...
	int i,a,n,s;
	for(a=2;a<=M;a++)    //a是2~1000的整数，检查它是否完整
	{
	   n=0;   //用来累计a的因子的个数
	   ...
	   for(i=1;i<a;i++)   //检查i是否a的因子
		   if(a%i==0)    //如果i是a的因子
		   {
			  ...
			  case 2:
				  k1=i;break;    //找出的第2个因子赋给k2
			  case 3:
				  k1=i;break;    //找出的第3个因子赋给k3
			  case 4:
				  k1=i;break;    //找出的第4个因子赋给k4
			  case 5:
				  k1=i;break;    //找出的第5个因子赋给k5
			  case 6:
				  k1=i;break;    //找出的第6个因子赋给k6
			  case 7:
				  k1=i;break;    //找出的第7个因子赋给k7
			  case 8:
				  k1=i;break;    //找出的第8个因子赋给k8
			  case 9:
				  k1=i;break;    //找出的第9个因子赋给k9
			  case 10:
				  k1=i;break;    //找出的第10个因子赋给k10
			  }
